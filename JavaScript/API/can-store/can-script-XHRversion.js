...
// The bunch of code below refers to an exercise: translate exactly a fetch() into XHR request
...
request.onload = function () {
  if (request.status == 200) {
    ...
    initialize();
    console.log('Network request for products.json succeeded with response ' + request.status + ': ' + request.statusText);
  }
  else {
